...
export default function HeroSection() {
  return (
    <>
    <main className="flex items-center justify-between mx-16 mt-20  ">
      <section className="w-2/4 flex flex-col gap-10 ">
        ...
        <div className="">
          <h1 className="hero_text">
            {" "}
            <span className=" linear_gradient_text">Dive</span> Into The Depths
          </h1>
          <h1 className="hero_text">
            Of{" "}
      ...
      <section>
        ...
        <div className=" relative flex items-center ">
            ...
            <Image src={heroimage}  alt="hero image"  width={400} height={400} className=""/>
            <Image src={herobg} alt="hero bg" className="absolute inset-0 -z-10"/> 
            </div>
            
        <Image src={curve1} alt="curve 1" className="absolute  -z-50 ml-[140px] mt-[20px]" width={320} height={320}/>
        <Image src={curve2} alt="curve 2" className="absolute -z-50 ml-[60px]" width={350} height={350} />
        <Image src={curve3} alt="curve 3" className="absolute  -z-50 ml-[-60px] mt-[250px]  " />
        </div>
        </section>
    </main>
